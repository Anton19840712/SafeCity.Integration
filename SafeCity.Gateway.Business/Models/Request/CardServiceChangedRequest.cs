namespace SafeCity.Gateway.Business.Models.Request
{
	public class CardServiceChangedRequest
	{
		...
		public string Card03StrDeliveredTo { get; set; }
		public DateTime? Card03DtAdmission { get; set; }
		public string Card03StrTeamMessage { get; set; }
	}
}
